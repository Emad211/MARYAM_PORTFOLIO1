...
import { LayoutDashboard, FileText, GraduationCap, Settings, UploadCloud, MessageSquare, UserCheck, ClipboardCheck } from "lucide-react";
import { useLanguage } from "@/context/language-context";
import type { Language } from "@/lib/types";

const sidebarLabels: Record<Language, { dashboard: string; messages: string; enrollments: string; blog: string; classes: string; lms: string; grading: string; deploy: string; settings: string }> = {
  en: { dashboard: "Dashboard", messages: "Messages", enrollments: "Enrollments", blog: "Blog Posts", classes: "Classes", lms: "LMS Content", grading: "Grading Queue", deploy: "Deploy", settings: "Settings" },
  de: { dashboard: "Dashboard", messages: "Nachrichten", enrollments: "Anmeldungen", blog: "Blogbeiträge", classes: "Kurse", lms: "LMS-Inhalte", grading: "Bewertungen", deploy: "Deployment", settings: "Einstellungen" },
  fa: { dashboard: "داشبورد", messages: "پیام‌ها", enrollments: "ثبت‌نام‌ها", blog: "پست‌های وبلاگ", classes: "کلاس‌ها", lms: "محتوای LMS", grading: "صف تصحیح", deploy: "استقرار", settings: "تنظیمات" },
};
